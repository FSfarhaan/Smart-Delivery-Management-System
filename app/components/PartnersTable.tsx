      ...
      <tbody>
        {couriers && couriers.map((courier, index) => (
          <tr key={index} className="border-t">
            <td className="py-3">{courier.name}</td>
            <td className="">
              <span
            ...
            <td className="text-center">{courier.metrics.rating}</td>
            <td className="text-center">{courier.metrics.completedOrders}</td>
            <td className="text-center">{courier.metrics.cancelledOrders}</td>
            <td className="text-center">{courier.currentLoad}</td>
